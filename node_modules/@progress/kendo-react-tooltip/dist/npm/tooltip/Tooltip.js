...
var Tooltip = /** @class */ (function (_super) {
    ...
    Tooltip.prototype.render = function () {
        ...
        return targetElement &&
            ...
            ReactDOM.createPortal((React.createElement("div", { ref: function (el) {
                ...
                }, className: kendo_react_common_1.classNames('k-animation-container', 'k-animation-container-fixed', 'k-animation-container-shown', this.props.className), style: __assign({ zIndex: currentZIndex }, this.props.style), tabIndex: 0 },
    ...
    Tooltip.prototype.showToolTip = function (event) {
        ...
        if (this.state.title !== titleResult.title) {
            kendo_react_common_1.dispatchEvent(this.props.onOpen, event, this, undefined);
        }
    };
     ...
     * @hidden
     */
    Tooltip.contextType = kendo_react_common_1.ZIndexContext;
    return Tooltip;
}(React.PureComponent));
