...
exports.Popover = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(kendo_react_common_1.ZIndexContext.Provider, { value: currentZindex },
        React.createElement(kendo_react_popup_1.Popup, { id: id, animate: animate, collision: collision, anchor: anchor, offset: offset, margin: margin, popupAlign: popupAlign, anchorAlign: anchorAlign, appendTo: appendTo, show: show, scale: scale, positionMode: positionMode, style: style, className: className, popupClass: basePopupClass, onOpen: handleOpen, onClose: handleClose, onPosition: handlePosition },
            callout && position &&
                (React.createElement("div", { className: kendo_react_common_1.classNames('k-popover-callout', calloutClass) })),
